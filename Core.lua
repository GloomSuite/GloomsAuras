...
local function SlashHandler(input)
  ...
  elseif cmd == "help" then
    ...
    print("  |cffffd200/ga bar cd <spellID>|r   — a Bar that drains while a spell is on cooldown")
    print("  |cffffd200/ga bar stacks <spellID> [max]|r — a Bar that fills with an aura's stack count")
