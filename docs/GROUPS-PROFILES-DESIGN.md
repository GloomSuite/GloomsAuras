...
> **Status: APPROVED, no code yet.** the owner reviewed and said "go with all your recommendations"
...
> Goal set by the owner: (1) **Groups** of auras with a **group-level visibility/load rule**
...
## 6. Decisions — ALL RESOLVED (the owner approved every recommendation, 2026-07-07)
...
- **Phase 2 — Grouped left pane.** ✅ **BUILT + QA'd 2026-07-07.** Headers (custom triangle caret +
  ...
  Manage Group drawer** (the owner's pick over inline buttons / right-pane): rename, load rule, on/off
  switch, move up/down, delete. Aura editor reduced to the assign dropdown. **Also added (the owner
