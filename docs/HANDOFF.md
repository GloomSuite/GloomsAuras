...
[docs/BARS-DESIGN.md](BARS-DESIGN.md) — READ IT FIRST.** Decided with the owner (2026-07-09): a Bar is a new
...
The owner's DoT timers), **Cooldown Duration**, **Stacks**. All secret-safe by the same rule ("feed the widget,
