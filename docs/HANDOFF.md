...
The owner kicked off an **effects/appearance** push (2026-07-08). Glow ✅ + grouped triggers ✅ + eye-preview /
...
### Exact charge COUNT (owner-requested revisit, after charge-availability build)
...
### Trigger-chooser UX (owner-requested 2026-07-08, AFTER Aimed Shot)
...
- **the owner's MAIN this season is Affliction Warlock** (added 2026-07-08) — char **"Gloomvale - Stormrage"**,
...
- The owner plays **Marksmanship Hunter** (**Dark Ranger** hero talents). Relevant IDs: Trick Shots buff
