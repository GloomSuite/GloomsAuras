...
local function Build()
  ...
  for i = 1, LIST_ROWS do
    ...
    -- Per-aura visibility toggle (aura rows only): the owner's eye icons — unhidden = shown,
  ...
  -- the owner's custom lock icons (Media/lock_locked.png / lock_unlocked.png) with colors
